...
namespace EMS
{
    public partial class Profile : System.Web.UI.Page
    {
        ...
        {
            con.Close();
            SqlCommand cmd = new SqlCommand("select * from EmpRegister where EmpId=@id",con);
        ...
        {
            con.Close();
            SqlCommand cmd = new SqlCommand("update EmpRegister set Name=@name,Contact=@contact,Email=@email where EmpId=@id",con);
